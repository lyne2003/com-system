...
<div id="addModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-sm p-6">
        <h3 class="text-lg font-bold text-gray-800 mb-4">Add Manufacturer</h3>
...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    {{-- FILTER BAR --}}
    <form method="GET" action="{{ route('manufacturers.index') }}" class="bg-white shadow-sm rounded-lg p-4 mb-6">
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 font-medium text-gray-800">{{ $mfr->name }}</td>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex justify-center gap-3">
                            <a href="{{ route('manufacturers.edit', $mfr->id) }}"
                               class="text-blue-600 hover:text-blue-800 font-medium">Edit</a>

                            <form method="POST" action="{{ route('manufacturers.destroy', $mfr->id) }}"
...
{{-- Auto-open modal if there are validation errors (name field failed) --}}
@if($errors->has('name'))
<script>
